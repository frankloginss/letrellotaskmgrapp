...
export class BoardComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private boardsService: BoardsService, //service to work with api
    private route: ActivatedRoute,
    private boardService: BoardService, //service to work on board state
  ...
  fetchData(): void {
    this.boardsService.getBoard(this.boardId).subscribe((board) => {
      this.boardService.setBoard(board); //board sent to board$ stream
    });
